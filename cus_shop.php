...
<!--end content area-->
  ...
  $qs3=mysql_query("select * from sc_product where status=4 && customer='$uname' ");
 ?>
   <table width="90%" align="center">
				...
				?>
				  <tr>
					...
					<td>
					<a href="cus_shop.php?act=get&pid=<?php echo $rs3['id']; ?>">Get ID</a> |
					<a href="cus_open.php?pid=<?php echo $rs3['id']; ?>" target="_blank">Verify</a></td>
				  </tr>
				 <?php
				 }
				 ?>
	  ...
	  $qq=mysql_query("select * from sc_product where id='".$pid."'");
		$rr=mysql_fetch_array($qq);
	  ?>
  <p align="center" class="style1">Product ID: <?php echo $rr['pcode']; ?></p>
  	<?php
	}
	?>
  <p>&nbsp;</p>
